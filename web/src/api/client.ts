...
/** Which of the three forms a card shows. */
export type PromptForm = 'v1' | 'v2' | 'v3'

/** How a card was drawn: the stage's five-word window, or a weighted random run. */
export type DrillMode = 'batch' | 'free'
